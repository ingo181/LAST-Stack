...
pub async fn update_task(
    ...
    let mut res = db
        ...
        .bind(("description".to_owned(),     req.description.unwrap_or_default()))
        .bind(("priority".to_owned(),        req.priority.as_ref().map(|p| p.to_string()).unwrap_or_default()))
        .bind(("progress_status".to_owned(), req.progress_status.as_ref().map(|s| s.to_string()).unwrap_or_default()))
        .bind(("risk_status".to_owned(),     req.risk_status.as_ref().map(|r| r.to_string()).unwrap_or_default()))
